...
@Component({
  selector: 'app-yiyecekicecek',
  templateUrl: './yiyecekicecek.component.html',
  styleUrls: ['./yiyecekicecek.component.scss']
})
export class YiyecekicecekComponent implements OnInit {
