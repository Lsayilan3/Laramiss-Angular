...
export class OrganizasyonComponent implements OnInit {
  ...
  shopgridpost = [
    ...
    {img:'../../../../assets/img/aaımg/orr_345x431.jpg',title:'Coffee Break Hizmeti',tag:'',price:'450',discountprice:'510', detay:'Menü içeriği genel olarak çay, kahve ve unlu mamülerden oluşan bir Catering dalıdır. Tüm aktivitelerde pratikliği ve kısa süreli atıştırmaya müsait olması nedeniyle iş dünyasında çok tercih edilmektedir. genel olarak fuar organizasyonları başta olmak üzere, seminer, toplantı, konferans etkinliklerinde misafir perverliğin bir göstergesi olarak kullanılmaktadır.'},
  ];
