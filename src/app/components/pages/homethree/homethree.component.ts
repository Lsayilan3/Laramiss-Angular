...
export class HomethreeComponent implements AfterViewInit {
  ...
  bannerposts = [
    { img: 'assets/img/banner/05.jpg', tag: 'Aşkla Süsleme Tasarımı', title: "Sizin İçin Mükemmel Tasarım ", btn1: 'explore more', btn2: 'Buy Now' },
    { img: 'assets/img/banner/06.jpg', tag: 'Aşkla Süsleme Tasarımı', title: 'Sizin İçin Mükemmel Tasarım ', btn1: 'explore more', btn2: 'Buy Now' },
  ];
  // Categories
  categoryposts = [
