...
export class HediyelikComponent implements OnInit {
  ...
  getHediyelik() {
		this.hediyelikservice.getHediyelikList().subscribe(data => {
			this.hediyeliks = data;
		
		});
  }

  // shopgridpost = [
  //   {img:'../../../../assets/img/places/02.jpg',title:'Kokteyl Organizasyonu',tag:'15% Off',price:'390',discountprice:'480',detay:'Etkinlikler ile ilgili fiyat bilgisi almamle irtibata geçebilirsiniz.'},
