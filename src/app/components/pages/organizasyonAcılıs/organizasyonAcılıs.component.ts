...
import { AcilisService } from './services/acilis.service';
import { OrAcilis } from './models/oracilis';
import { Component, OnInit } from '@angular/core';

@Component({
  selector: 'app-organizasyonAcılıs',
  templateUrl: './organizasyonAcılıs.component.html',
  styleUrls: ['./organizasyonAcılıs.component.scss']
})
export class OrganizasyonAcılısComponent implements OnInit {
  ...
  getAcilis() {
		this.acilisService.getOrAcilisList().subscribe(data => {
			this.orAcilises = data;
